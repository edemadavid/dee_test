...
<div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
                <div class="flex items-center justify-start md:justify-center pl-1 w-14 md:w-64 h-14 bg-blue-800 dark:bg-gray-800 border-none">
                    <img class="w-7 h-7 md:w-10 md:h-10 mr-2 rounded-md overflow-hidden" src="<?php 
                            if (empty($user->photo)) 
                ...
                <ul class="flex items-center">
                    ...
                    <li>
                    <a href="<?php echo  URLROOT ?>usercontroller/logout" class="flex items-center mr-4 hover:text-blue-100">
