...
<div x-data="setup()" :class="{ 'dark': isDark }">
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
      ...
      <div class="h-full w-auto ml-14 mt-14 mb-10 md:ml-64 md:container">
        ...
        <form class="p-6 flex flex-col justify-center" action="<?php echo URLROOT; ?>profilecontroller/create"  method="POST" enctype="multipart/form-data">

            <div class="flex flex-col mt-4">
                <label for="username" class="">Full Name</label>
                <input type="text" name="fullname" id="fullname" placeholder="Full Name" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
            ...
            <div class="flex mt-4">
              ...
              <div>
                ...
                <img 
                  ...
                  src="https://therminic2018.eu/wp-content/uploads/2018/07/dummy-avatar.jpg" alt="profile pics">
