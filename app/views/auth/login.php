    ...
    <section class="min-h-screen flex items-stretch text-white ">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            ...
            <div class="w-full py-6 z-20">
                ...
                <form action="<?php echo URLROOT; ?>usercontroller/login" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    <div class="pb-2 pt-4">
                    <span class="text-red-500 text-xs italic" ><?php echo $data['usernameError']; ?></span>
                        <input type="text" name="username" value="<?php echo $data['username']; ?>" placeholder="Username" class="block w-full p-4 text-lg rounded-sm bg-black">
                    </div>
                    <div class="pb-2 pt-4">
                    ...
                    <div class="text-center text-gray-400 hover:underline hover:text-gray-100">
                        <a href="<?php echo URLROOT; ?>usercontroller/register">Don't have an account? Please Register</a>
                    </div>
