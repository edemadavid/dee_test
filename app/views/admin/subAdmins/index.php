                  ...
                  <div class="mt-4 mx-4">
                    <div class="flex flex-wrap items-center px-4 py-2">
                      <div class="relative w-full max-w-full flex-grow flex-1">
                        <h1 class="font-semibold text-3xl text-gray-900 dark:text-gray-50">Teachers List</h1>
                      </div>
                      <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                        <a href="<?php echo  URLROOT ?>teachercontroller/create" class="bg-blue-500 dark:bg-gray-100 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Add New Teacher</a>
                      </div>
                    </div>
                        ...
                        <table class="w-full">
                          <thead>
                            <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                              ...
                              <th class="px-4 py-3">Quiz Count</th>
                          ...
                          <?php 
                            ...
                            $teachersProfile = $data['teachersProfile'];


                            foreach ($teachers as $teacher)  : ?>
                            <?php //var_dump($teachersProfile)?>
                              <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                  ...
                                  <div class="flex items-center text-sm">
                                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                      <img class="object-cover w-full h-full rounded-full" 
                                        src="<?php 
                                                if (empty($teachersProfile[$teacher->user_id]->photo)) 
                                                    {echo "https://therminic2018.eu/wp-content/uploads/2018/07/dummy-avatar.jpg";
                                                } else { echo FILE_ROOT.$teachersProfile[$teacher->user_id]->photo ; } 
                                              ?>" alt="" loading="lazy" />
                                      <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                    </div>
                                    <div>
                                      <p class="font-semibold"><?php echo $teacher->users_name ?></p>
                                      <p class="text-xs text-gray-600 dark:text-gray-400"><?php echo $teacher->user_email ?></p>
                                    </div>
                                  </div>
                                </td>
                                ...
                                <td class="px-4 py-3 text-sm"><?php echo date('F j h:i', strtotime($teacher->timeCreated) ) ?></td>
                                <td>
                                  <a
                                      class=""
                                      href="<?php echo URLROOT . "teachercontroller/update/" . $teacher->user_id ?>">
                                      Update
                                  </a>
                                  <form action="<?php echo URLROOT . "/teachercontroller/delete/" . $teacher->user_id ?>" method="POST">
