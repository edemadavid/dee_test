                    ...
                    <div class="lg:container pr-1">
                        <div class="flex flex-wrap items-center px-4 py-0">
                            <div class="relative w-full max-w-full flex-grow flex-1">
                                ...
                                <h1 class="font-semibold text-3xl text-gray-900 dark:text-gray-50">Add a New Question</h1>
                            </div>
                        </div>

                        <p class="text-red-500 text-xs italic"> <?php echo $data['test'] ?> </p>
                        <form class="p-6 " action="<?php echo URLROOT; ?>quizcontroller/create" method="POST">
                            ...
                            <div class="flex flex-col mt-4">
                                ...
                                <textarea name="question" id="" cols="5" rows="3"  placeholder="question" class="w-full lg:w-90 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"><?php echo $data['question'] ?></textarea>
                            ...
                            <div class="flex flex-col mt-10">
                                ...
                                <input type="text" name="optA" id="optA" placeholder="Option A" value="<?php echo $data['optA']; ?>"class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
                                <p class="text-red-500 text-xs italic"> <?php echo $data['optAError'] ?> </p>
                            </div>
                    
                            <div class="flex flex-col mt-2">
                                <label for="optionB" class="">Option B</label>
                                <input type="text" name="optB" id="optB" placeholder="Option B" value="<?php echo $data['optB']; ?>"class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
                            ...
                            <div class="flex flex-col mt-2">
                                ...
                                <input type="text" name="optC" id="optC" placeholder="Option C" value="<?php echo $data['optC']; ?>"class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
                            ...
                            <div class="flex flex-col mt-2">
                                ...
                                <input type="text" name="optD" id="optD" placeholder="Option D" value="<?php echo $data['optD']; ?>"class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
