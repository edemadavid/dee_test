                ...
                <div class="grid grid-cols-1 p-4 gap-4">
                  ...
                  <div class="mt-4 mx-4">
                        ...
                        <div class="relative w-full max-w-full flex-grow flex-1">
                            <h1 class="font-semibold text-3xl text-gray-900 dark:text-gray-50">Create Subject</h1>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <form class="p-6 flex flex-col justify-center" action="<?php echo  URLROOT ?>subjectcontroller/create"  method="POST">
                            
                                <div class="flex flex-col">
                                    <label for="SubjectTitle" class="hidden">Subject Title</label>
                                    <input type="text" name="subjectTitle" placeholder="Subject Title" value="<?php //echo $data['username']; ?>" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
